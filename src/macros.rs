...
///
/// heap-struct:
///     "pub"? "struct" IDENT "/" IDENT "/" IDENT "<'a>" "{" heap-struct-field,* "}"
///
/// heap-struct-field:
///     IDENT / IDENT ":" TYPE
///
/// heap-enum:
///     "pub"? "enum" IDENT "/" IDENT "<'a>" "{" heap-enum-variant,* "}"
///
/// heap-enum-variant:
///     IDENT
///     IDENT "(" TYPE,* ")"
...
///
/// gc_heap_type! {
///     struct Object / ObjectRef / ObjectInHeap <'a> {
///         name / set_name : String,
///         description / set_description: String,
///         children / set_children: VecRef<'a, ObjectRef<'a>>
///     }
/// }
/// # fn main() {}
/// ```
///
/// Note that `children` is a `VecRef<'a, ObjectRef<'a>>`; that is, it is a
/// reference to a separately GC-allocated `Vec<ObjectRef<'a>>`, which is a
/// vector of references to other objects. In other words, this is exactly what
/// you would have in Java for a field declared
/// `public ArrayList<Object> children;`.
///
/// The API generated by this macro looks like this:
///
/// ```
/// # struct VecRef<'a, T: 'a>(&'a T);  // hack to make this compile
/// struct Object<'a> {
///     name: String,
///     description: String,
///     children: VecRef<'a, ObjectRef<'a>>
/// }
///
/// struct ObjectRef<'a> {
///    /* all fields private */
/// #  target: &'a Object<'a>     // hack to make this compile
/// }
///
/// impl<'a> ObjectRef<'a> {
///     fn name(&self) -> String
...
/// #       { unimplemented!(); }
///     fn children(&self) -> VecRef<'a, ObjectRef<'a>>
/// #       { unimplemented!(); }
///     fn set_children(&self, children: VecRef<'a, ObjectRef<'a>>)
/// #       { unimplemented!(); }
/// }
/// ```
///
